    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 bg-gradient-to-br from-sky-400 via-blue-500 to-blue-600 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
          ...
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-1">Admin Portal</h2>
          <p className="text-gray-500 text-sm text-center mb-2">Sign in to your Techna Admin Dashboard</p>

          {/* Admin only badge */}
          <div className="flex items-center justify-center gap-1.5 mb-6">
            <ShieldCheck className="w-4 h-4 text-blue-600" />
            <span className="text-xs font-medium text-blue-600">Authorized Admin Access Only</span>
          </div>
